...
st.error("⚠️ข้อมูลในฐานข้อมูลเป็นเพียงข้อมูลสมมุติเพื่อแสดงให้เห็นประสิทธิภาพการทำงานของระบบ Care360Plus เท่านั้น")
st.error("💡ท่านคณะกรรมการ สามารถเพิ่ม ลบ แก้ไข ข้อมูลได้ตามต้องการ")
